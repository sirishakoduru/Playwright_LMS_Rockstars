...
Given Admin is on the Batch Details Page
When Admin enters the valid data to all the mandatory fields with "<DataInput>","<SheetName>" and click save button 
Then Admin should get a successful message for editing the batch
Examples:
|   DataInput        | SheetName  |
|   EnterMandatoryFeildsforEdit  | Batch|

Scenario Outline: validate cancel button in Batch details pop up
Given Admin is on the Batch Details Page
When Admin enters the valid data to all the mandatory fields "<DataInput>","<SheetName>" for edit and click cancel button 
Then Admin can see the batch details popup closes without editing the batch
Examples:
|   DataInput        | SheetName  |
|   clickCancelButtonForEdit  | Batch|
